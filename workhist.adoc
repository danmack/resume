...
* distributed ledger/blockchain software developement in python
* CI pipeline design and implementation
...
Management of team responsible for Code42's Consumer and Enterprise cloud storage infrastructure

* Led team which scaled the Code 42 cloud by a factor of 4 to over 300
  petabytes of storage across 7 global datacenter locations
* Improved key metrics of the cloud service including availability,
  time to provision, data durability, unit cost, and quality of
  service
* Grew the team to add additional competencies which added value to
  our products
* Responsible for delivering the Cloud service to customers through
  mature repeatable process, a great team, and the right technology
****
...
Team lead of the storage support team covering production storage
assets.
...
Multistore) to support increased utilization of storage capacity
...
* supported computer science department UNIX systems and graducate computing labs
...
Science Laboratories. Primary responsibiltiesa included:
